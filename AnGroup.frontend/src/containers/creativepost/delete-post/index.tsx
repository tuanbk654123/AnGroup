...
import { creativePostDeleteListRequest } from '~/redux/slices/creativepost/middleware'
import { RouterHelper } from '~/utils'
import { CloseIcon } from '~/components/common/icons/index'

export const DeleteCreativePostModal = (props) => {
  ...
  return (
    <Modal title={t("creativepost.deleteCreativePost")} style={{ textAlign: "center" }}
