...
export const CreateCreativePostCrawlModal = (props) => {
  const { showAdd, hideAdd, loadPage, setLoadPage, showView, hideView,
    dataCrawl, setDataCrawl } = props;
  ...
  useEffect(() => {
    ...
    if (showAdd == true) {
      form.setFieldsValue({
        contentHTML: dataCrawl?.contentHTML,
        title: dataCrawl?.title ,
        description: dataCrawl?.description ,
        categoryId:null ,
        author: dataCrawl?.author ,
        address:dataCrawl?.address ,
        tags:dataCrawl?.tags ,
        comment:dataCrawl?.comment ,
      })
      setImageUrl(dataCrawl?.image);
      setValue(dataCrawl?.newsType==1?dataCrawl?.newsType:dataCrawl?.newsType==2?dataCrawl?.newsType:dataCrawl?.newsType==3?dataCrawl?.newsType:1)
      getAllCategory()
    }
    console.log(1)
