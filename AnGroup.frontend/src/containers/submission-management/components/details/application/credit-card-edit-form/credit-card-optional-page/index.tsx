...
import { FormItem, PapperPopupConfirm, PappperButton, RotatableImage, SelectBox, TextInputArea } from '~/components/common'
...
export interface ICreditCardOptionalPageEditFormProps {
  reasonPage?: number
  isOptionalPage?: boolean
}

export default function CreditCardOptionalPageEditForm({
  reasonPage,
  isOptionalPage,
}: ICreditCardOptionalPageEditFormProps) {
  ...
  }, [dataSubmissionDetails, reasonPage, isOptionalPage, setDocuments, setData])
    ...
    <Form layout="vertical" form={form}>
      ...
      <Row gutter={24} className="justify-center flex">
        ...
        {/* // <Col key={index} className="justify-center flex">
          //   <div className={`flex justify-center mb-10 ${isOptionalPage ? 'w-1/4' : 'w-full '}`}>
          //     <RotatableImage zoomable src={doc} />
          //   </div>
          // </Col>
      */}
      </Row>
