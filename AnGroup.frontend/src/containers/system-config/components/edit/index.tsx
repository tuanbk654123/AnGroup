...
import { FastConfigHeaderForDetails } from '../header/for-details'

export default function FastConnectionConfigDetailContainer() {
  ...
  const handleCancel = () => {
    navigate({
      pathname: RouterHelper.configuration_DMS_connection,
    })
  }
  return (
    <div>
      <FastConfigHeaderForDetails />
