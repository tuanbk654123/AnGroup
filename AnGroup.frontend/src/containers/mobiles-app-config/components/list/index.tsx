...
const MobilesAppConfigList = () => {
  ...
  const handleEdit = (recordEdit: RecordDataType) => {
    navigate({
      pathname: RouterHelper.configuration_mobile_app_detail_ref(recordEdit.varname),
      search: createSearchParams({ ...currentParams, varname: recordEdit.varname, vargroup: 'MOBILE' }).toString(),
    })
  }
...
export default MobilesAppConfigList
